...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/home", "/api/home/reset-timer", "/api/registration").permitAll()
                .requestMatchers("/api/check-email", "/api/reset-code", "/api/refresh-password").permitAll()
                ...
                .requestMatchers("/api/characters/admin/add").hasAnyAuthority("ADMIN", "MANAGER")
                .requestMatchers("/api/characters/admin/request/**").hasAnyAuthority("ADMIN", "MANAGER")
